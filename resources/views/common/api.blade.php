...
<x-app-layout>
    <div class="my-6 md:my-9">
        ...
        <div class="space-y-4 bg-white p-3 rounded-md mb-10 shadow-custom">
            ...
            <div>
                <p class="text-lg text-gray-700 font-semibold">自适应设备</p>
                <x-code><span class="text-sky-500 select-none">GET </span>/images/adaptive</x-code>

                <p class="text-sm mt-4 mb-2 text-gray-500">根据请求的 User-Agent 自动返回适配当前设备的图片，无需手动传参。</p>

                <div class="my-4 overflow-x-auto">
                    <p class="text-sm mb-2">设备映射规则</p>
                    <table class="min-w-full">
                        <thead class="bg-white border">
                        <tr>
                            <th scope="col" class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">设备</th>
                            <th scope="col" class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider whitespace-nowrap">目标画幅</th>
                        </tr>
                        </thead>
                        <tbody class="bg-white border divide-y text-sm">
                        <tr><td class="px-3 py-2 whitespace-nowrap">iPhone / iPod</td><td class="px-3 py-2 whitespace-nowrap">竖版 portrait</td></tr>
                        <tr><td class="px-3 py-2 whitespace-nowrap">Android 手机</td><td class="px-3 py-2 whitespace-nowrap">竖版 portrait</td></tr>
                        <tr><td class="px-3 py-2 whitespace-nowrap">iPad</td><td class="px-3 py-2 whitespace-nowrap">横版 4:3</td></tr>
                        <tr><td class="px-3 py-2 whitespace-nowrap">Android 平板</td><td class="px-3 py-2 whitespace-nowrap">横版 16:9</td></tr>
                        <tr><td class="px-3 py-2 whitespace-nowrap">Windows / Mac</td><td class="px-3 py-2 whitespace-nowrap">横版 16:9</td></tr>
                        <tr><td class="px-3 py-2 whitespace-nowrap">其他设备</td><td class="px-3 py-2 whitespace-nowrap">横版 (fallback)</td></tr>
                        </tbody>
                    </table>
                </div>
                <p class="text-sm text-gray-500">渐进回退：比例不匹配 → 仅按方向 → 完全随机，保证始终有图返回。</p>

            </div>
            <div>
                <p class="text-lg text-gray-700 font-semibold">随机图片</p>
                <x-code><span class="text-sky-500 select-none">GET </span>/images/random</x-code>

                <p class="text-sm mt-4 mb-2 text-gray-500">随机返回当前用户的一张图片。所有参数可选，组合使用可精确筛选。</p>
                ...
                <div class="my-4 overflow-x-auto">
                    ...
                    <table class="min-w-full">
                        ...
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">album_id</td>
                            <td class="px-3 py-2 whitespace-nowrap">Integer</td>
                            <td class="px-3 py-2 whitespace-nowrap">相册 ID，传 0 表示未分类</td>
                        </tr>
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">orientation</td>
                            <td class="px-3 py-2 whitespace-nowrap">String</td>
                            <td class="px-3 py-2 whitespace-nowrap">画幅方向：landscape(横版) / portrait(竖版) / square(正方形)</td>
                        </tr>
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">ratio</td>
                            <td class="px-3 py-2 whitespace-nowrap">String</td>
                            <td class="px-3 py-2 whitespace-nowrap">画幅比例，如 16:9、4:3、3:2，或直接传小数 1.778（容差 ±5%）</td>
                        </tr>
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">min_width</td>
                            <td class="px-3 py-2 whitespace-nowrap">Integer</td>
                            <td class="px-3 py-2 whitespace-nowrap">最小宽度(px)</td>
                        </tr>
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">max_width</td>
                            <td class="px-3 py-2 whitespace-nowrap">Integer</td>
                            <td class="px-3 py-2 whitespace-nowrap">最大宽度(px)</td>
                        </tr>
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">min_height</td>
                            <td class="px-3 py-2 whitespace-nowrap">Integer</td>
                            <td class="px-3 py-2 whitespace-nowrap">最小高度(px)</td>
                        </tr>
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">max_height</td>
                            <td class="px-3 py-2 whitespace-nowrap">Integer</td>
                            <td class="px-3 py-2 whitespace-nowrap">最大高度(px)</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="my-4 overflow-x-auto">
                    ...
                    <table class="min-w-full">
                        ...
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">origin_name</td>
                            <td class="px-3 py-2 whitespace-nowrap">String</td>
                            <td class="px-3 py-2 whitespace-nowrap">图片原始名称</td>
                        </tr>
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">pathname</td>
                            <td class="px-3 py-2 whitespace-nowrap">String</td>
                            <td class="px-3 py-2 whitespace-nowrap">图片路径名</td>
                        </tr>
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">size</td>
                            <td class="px-3 py-2 whitespace-nowrap">Float</td>
                            <td class="px-3 py-2 whitespace-nowrap">图片大小，单位 KB</td>
                        </tr>
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">width</td>
                            <td class="px-3 py-2 whitespace-nowrap">Integer</td>
                            <td class="px-3 py-2 whitespace-nowrap">图片宽度</td>
                        </tr>
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">height</td>
                            <td class="px-3 py-2 whitespace-nowrap">Integer</td>
                            <td class="px-3 py-2 whitespace-nowrap">图片高度</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td class="px-3 py-2 whitespace-nowrap">links</td>
                            <td class="px-3 py-2 whitespace-nowrap">Object</td>
                            <td class="px-3 py-2 whitespace-nowrap">链接，含 url / html / markdown / bbcode 等</td>
                        </tr>
                        </tbody>
                    </table>
                </div>
